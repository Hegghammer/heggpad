...
It's the same idea that powers [Obsidian tasks](https://community.obsidian.md/plugins/obsidian-tasks-plugin), the most widely used plaintext todo standards after [GFM tasks](https://github.github.com/gfm/#example-279). Instead of bothering with ASCII syntax like that of [todo.txt](http://todotxt.org), it just uses emojis.
